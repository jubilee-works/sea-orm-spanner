        ...
        manager
            .create_table_spanner(
                SpannerTableBuilder::new()
                    .table("chat_messages")
                    .string("id", Some(36), true)
                    .string("session_id", Some(36), true)
        ...
        manager
            .create_table_spanner(
                SpannerTableBuilder::new()
                    ...
                    .string("id", Some(36), true)
                    .string("user_id", Some(36), true)
                    .string("session_id", Some(36), false)
                    .string("message_id", Some(36), false)
                    .string("title", Some(500), false)
        ...
        manager
            .create_table_spanner(
                SpannerTableBuilder::new()
                    ...
                    .string("id", Some(36), true)
                    .string("schedule_id", Some(36), true)
        ...
        manager
            .create_table_spanner(
                SpannerTableBuilder::new()
                    ...
                    .string("source_id", Some(36), false)
